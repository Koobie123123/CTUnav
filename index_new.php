<?php
// Simple Router for CTU Tuburan System
...
$routes = [
    '' => 'index.php', // Home page - redirect to self for now
    'home' => 'index.php',
    'login' => 'login.php',
    'logout' => 'logout.php',
    ...
    'admin/manage_account' => 'admin/admin_dashboard.php?page=manageAccount',
    'admin/manage_staff' => 'admin/admin_dashboard.php?page=staffList',
    'admin/manage_offices' => 'admin/admin_dashboard.php?page=manageOffices',
    'admin/manage_map' => 'admin/admin_dashboard.php?page=manageMap',
    'messages' => 'messages.php',
    'profile' => 'profile.php',
    'user_profile' => 'user_profile.php',
    'virtual_tour' => 'virtual_tour.php',
    'chatbot' => 'chatbot.html',
    'manage_chatbot' => 'manage_chatbot.php',
    'manage_queries' => 'manage_queries.php',
    'user_manage_pass' => 'user_manage_pass.php',
    'staff_profile' => 'staff_profile.php',
    'mark_read' => 'mark_read.php',
    'user_mark_as_read' => 'user_mark_as_read.php',
    'send_message' => 'send_message.php',
    'fetch_message' => 'fetch_message.php',
];

// Handle special cases for admin routes with parameters
if (strpos($route, 'admin/') === 0) {
    $adminRoute = str_replace('admin/', '', $route);
    if (isset($routes["admin/{$adminRoute}"])) {
        $file = $routes["admin/{$adminRoute}"];
...
if (isset($routes[$route])) {
    ...
    // Handle special cases where we need to pass query parameters
    if (strpos($file, '?') !== false) {
        parse_str(strstr($file, '?'), $params);
        $_GET = array_merge($_GET, $params);
        $file = strstr($file, '?', true);
...
// If route not found or file doesn't exist, show home page
if ($route === '' || !file_exists($routes[$route] ?? '')) {
    // Show the original home page content
    ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="navbar">
    ...
    <div class="navbar-right">
        <ul class="nav-links">
            <li><a href="/dashboard">Campus Map</a></li>
            <li><a href="/virtual_tour">Virtual Tour</a></li>
