...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // ✅ Check if email is already used by another staff/user
...
// Re-fetch updated staff data
$stmt = $conn->prepare("SELECT first_name, middle_name, last_name, email, profile_image, departmentID FROM users WHERE userID = ?");
...
<head>
  ...
  <title>Staff Profile - CTU Tuburan</title>
...
<nav class="navbar">
    <div class="navbar-left">
        ...
        <span class="logo-text">CTU-TUBURAN STAFF</span>
    </div>
    <div class="navbar-right">
        ...
        <a href="staff_messages.php">
            <svg class="icon" viewBox="0 0 24 24">
                <path d="M20 2H4a2 2 0 0 0-2 2v16l4-4h14a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2z"/>
            </svg>
        </a>
        <a href="staff_profile.php">
            <img class="profile" src="<?= htmlspecialchars($profileImage) ?>" alt="Profile" />
        </a>
    </div>
</nav>
...
<main class="main-container">
  <!-- Sidebar -->
  <nav class="sidebar">
    <a href="staff_profile.php" class="active">Manage Account</a>
    <a href="staff_manage_pass.php">Manage Password</a>
  ...
  <section class="profile-container">
    ...
    <div class="profile-photo">
      ...
      <div style="font-size:14px; color:gray;">
        Department: <?= htmlspecialchars($user['departmentID'] ?? 'N/A') ?>
      </div>
    </div>
